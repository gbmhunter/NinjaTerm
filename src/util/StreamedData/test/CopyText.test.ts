...
describe('StreamedDataCopyTextTests', () => {
  ...
  it('copyTest', () => {
    ...
    outputStreamedData.copyCharsFrom(inputStreamedData, 2, MarkerBehaviour.NOT_FILTERING)
  ...
  it('extractAppendAndNodeTextTest', () => {
    ...
    outputStreamedData.copyCharsFrom(inputStreamedData, 6, MarkerBehaviour.NOT_FILTERING)
  ...
  it('copyJustAfterColorTest', () => {
    ...
    outputStreamedData.copyCharsFrom(inputStreamedData, 7, MarkerBehaviour.NOT_FILTERING)
  ...
  it('outputAlreadyPopulatedTest', () => {
    ...
    outputStreamedData.copyCharsFrom(inputStreamedData, 4, MarkerBehaviour.NOT_FILTERING)
  ...
  it('colorNoTextTest', () => {
    inputStreamedData.addMarker(new ColourMarker(inputStreamedData.getText().length, '#ff0000'))
    expect(inputStreamedData.getText()).toEqual('')
    expect(inputStreamedData.getColourMarkers().length).toEqual(1)
    expect(inputStreamedData.getColourMarkers()[0].color).toEqual('#ff0000')

    outputStreamedData.copyCharsFrom(inputStreamedData, 0, MarkerBehaviour.NOT_FILTERING);
  ...
  it('colorToAddOnNextCharInOutputTest', () => {
    ...
    outputStreamedData.addMarker(new ColourMarker(outputStreamedData.getText().length, '#ff0000'))
    outputStreamedData.copyCharsFrom(inputStreamedData, 3, MarkerBehaviour.NOT_FILTERING)
  ...
  it('copyWithPreexistingDataTest', () => {
    ...
    outputStreamedData.addMarker(new ColourMarker(
      outputStreamedData.getText().length, '#00ff00'
    ))

    outputStreamedData.copyCharsFrom(inputStreamedData, inputStreamedData.getText().length, MarkerBehaviour.NOT_FILTERING)
