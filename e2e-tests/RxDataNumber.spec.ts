...
test.describe('Parsing RX data as numbers (Electron)', () => {

  test('single hex value', async () => {
    await appTestHarness.openPortAndGoToTerminalView();

    await appTestHarness.goToRxSettings();
    // Set the data type to "Number"
    await appTestHarness.page.getByTestId('data-type-number-radio-button').check();

    // Set the subtype to "Hex"
    await appTestHarness.page.getByTestId('number-type-select').click();
    await appTestHarness.page.click('li[data-value="Hex"]');
  ...
  test('lowercase hex values', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    ...
    await appTestHarness.page.getByTestId('hex-lowercase-radio-button').check();
  ...
  test('make sure little endian multibyte hex values work', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    ...
    await appTestHarness.page.getByTestId('num-bytes-per-hex-number-input').fill('2');
    await appTestHarness.page.getByTestId('num-bytes-per-hex-number-input').press('Enter'); // Press enter to "apply" change
  ...
  test('make sure big endian multibyte hex values work', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    ...
    await appTestHarness.page.getByTestId('endianness-select').click();
    await appTestHarness.page.click('li[data-value="Big Endian"]');
    ...
    // Because big endian is selected, the bytes in each number should be displayed in forward order
    const expectedDisplay: ExpectedTerminalChar[][] = [
      [
        new ExpectedTerminalChar({ char: '0' }),
        new ExpectedTerminalChar({ char: '1' }),
  ...
  test('two uint8 values with 0s as padding', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    ...
    await appTestHarness.page.getByTestId('number-type-select').click();
    await appTestHarness.page.click('li[data-value="uint8"]');
  ...
  test('one int8 value, padding: 0s, endianness: little', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    ...
    await appTestHarness.page.getByTestId('number-type-select').click();
    await appTestHarness.page.click('li[data-value="int8"]');
  ...
  test('make sure padding with spaces goes before the negative sign', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    ...
    await appTestHarness.page.getByTestId('pad-whitespace-radio-button').check();
  ...
  test('one uint16 value, padding: 0s, endianness: little', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    ...
    await appTestHarness.page.getByTestId('number-type-select').click();
    await appTestHarness.page.click('li[data-value="uint16"]');
  ...
  test('one uint16 value, padding: 0s, endianness: big', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
  ...
  test('one int16 value, padding: 0s, endianness: little', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    ...
    await appTestHarness.page.getByTestId('number-type-select').click();
    await appTestHarness.page.click('li[data-value="int16"]');
  ...
  test('two int16 values, padding: 0s, endianness: little', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
  ...
  test('one uint32 value, padding: 0s, endianness: little', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    ...
    await appTestHarness.page.getByTestId('number-type-select').click();
    await appTestHarness.page.click('li[data-value="uint32"]');
  ...
  test('one int32 value, padding: 0s, endianness: little', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    ...
    await appTestHarness.page.getByTestId('number-type-select').click();
    await appTestHarness.page.click('li[data-value="int32"]');
  ...
  test('one uint64 value, padding: 0s, endianness: little', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    ...
    // Set the subtype to "uint32"
    await appTestHarness.page.getByTestId('number-type-select').click();
    await appTestHarness.page.click('li[data-value="uint64"]');
  ...
  test('one float32 value, padding: 0s, endianness: little', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    ...
    await appTestHarness.page.getByTestId('number-type-select').click();
    await appTestHarness.page.click('li[data-value="float32"]');
