...
test.describe('RX data (Electron)', () => {
  ...
  test('ESC[0m should reset CSI styles', async () => {
    const TX_COLOR = 'rgb(0, 255, 0)'; // green
    const RX_COLOR = 'rgb(255, 255, 0)'; // yellow
  ...
  test('ESC[2A should go up 2 rows', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    // ESC[m should be interpreted as ESC[0m
  ...
  test('ESC[1D should go back 1', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    // ESC[m should be interpreted as ESC[0m
  ...
  test('ESC[J rewriting a single row', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
    // ESC[m should be interpreted as ESC[0m
  ...
  test('ESC[J clearing multiple rows', async () => {
    await appTestHarness.openPortAndGoToTerminalView();
  ...
  test('do nothing new line cursor behavior should work', async () => {
    await appTestHarness.openPortAndGoToTerminalView();

    await appTestHarness.goToRxSettings();
    await appTestHarness.page.getByTestId('new-line-dont-move-cursor').click();
