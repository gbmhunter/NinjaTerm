...
Only RTT up-channel 0 and down-channel 0 are used — the default Segger `SEGGER_RTT_printf` / `SEGGER_RTT_Read` channels. Multi-channel RTT is not currently supported.
